...
class JForStatement extends JStatement {
    ...
    public JForStatement(int line, JStatement initial, JExpression condition, 
...
//        if (initial != null) { //only if initialized
//            initial = (JVariableDeclarator) initial.analyze(context);
//        }
